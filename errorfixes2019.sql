...
# Other issue.  Date is incorrect for litter 9342
UPDATE litter
SET date1 = "2019-07-29"
WHERE id = 9342 AND squirrel_id = 23378;



# Prior to 2013 the detail codes for travelling were reversed.
UPDATE behaviour
SET detail = 9
WHERE behaviour = "3" AND detail = "1" AND date < "2013-01-01";

UPDATE behaviour
SET detail = 1
WHERE behaviour = "3" AND detail = "2" AND date < "2013-01-01";


UPDATE behaviour
SET detail = 2
WHERE behaviour = "3" AND detail = "9" AND date < "2013-01-01";

#There were some errors in the detail column for travelling
UPDATE behaviour
SET detail = NULL
WHERE behaviour = "3" AND detail NOT IN ('1', '2');


# Prior to 2013 the coding for RC was not teh same as the coding for rep_con for females.  So here I am setting to NULL rep-con for females prior to 2013.  
#Reproductive status for females prior to 2013 will need to be linked from dbatrapping and the user should note the changes in coding
UPDATE trapping
SET rep_con = NULL
WHERE date < "2013-01-01" AND sex NOT IN ('M');
